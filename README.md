...
```html
<link rel="stylesheet" type="text/css" href="https://unpkg.com/@propjockey/doubledash.css@0.0.0/doubledash.css">
```
...
```css
@import url("https://unpkg.com/@propjockey/doubledash.css@0.0.0/functions/repeat.css");
```
